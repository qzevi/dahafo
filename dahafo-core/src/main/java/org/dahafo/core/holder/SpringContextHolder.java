...
public class SpringContextHolder implements ApplicationContextAware, DisposableBean {
     ...
     * <br/> 详细描述：根据Bean的名称从Spring容器中获取Bean对象�?
     * <br/> 使用方式：java代码中可直接调用此静态方法�??
     * 
     * @param name bean名称�?
     * @return T 返回相应的对象�??
     */
     ...
     * <br/> 详细描述：根据Class从Spring容器中获取Bean�?
     * <br/> 使用方式：java代码中可直接调用此静态方法�??
     * 
     ...
     * <br/> 详细描述：根据Bean名称和Class从Spring容器中获取Bean对象�?
     * <br/> 使用方式：java代码中可直接调用此静态方法�??
     * 
     * @param name bean名称�?
     * @param clazz Class实例�?
     ...
     * <br/> 详细描述：获取Spring容器中的BeanDefinition Map�?
     * <br/> 使用方式：java代码中可直接调用此方法�??
     * 
